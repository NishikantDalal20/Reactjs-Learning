...
function App() {
 ...
 useEffect(() => {
      ...
      return (
        ...
        <div
            className="w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat bg-[#A6979C]"
            // style={{
        ...
        >
            ...
            <div className="w-full">
                     {/* Heading just above the box */}
  <h1 className="text-3xl font-bold text-black mb-4 text-center">Currency Convertor</h1>
